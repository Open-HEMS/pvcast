...
# for timepd.Series frequency options see: https://pandas.pydata.org/docs/user_guide/timepd.Series.html#offset-aliases
energy_sch = Schema(
    base_sch.extend(
        {
            ...
            Required("data"): [
                {
                    # HA uses RFC 3339 pd.Timestamps in format: "2023-07-01T21:00:00+00:00"
