...
def get_weather_api() -> API_FACTORY:
    ...
    weather_data_source = _config_reader.config["general"]["weather"]["weather_source"]["source"]
    ...
    return API_FACTORY.get_weather_api(weather_data_source, max_forecast_days=max_forecast_days, location=location)
