...
TEST_CONF_PATH_SEC = Path(__file__).parent.parent / "unit" / "test_config_sec.yaml"
TEST_CONF_PATH_NO_SEC = Path(__file__).parent.parent / "unit" / "test_config_no_sec.yaml"
TEST_CONF_PATH_ERROR = Path(__file__).parent.parent / "unit" / "test_config_error.yaml"
TEST_SECRETS_PATH = Path(__file__).parent.parent / "unit" / "test_secrets.yaml"
